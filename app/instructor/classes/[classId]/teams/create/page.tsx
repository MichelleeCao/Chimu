...
export default function CreateTeamPage({ params }: { params: { classId: string } }) {
  ...
  const onSubmit = async (values: CreateTeamFormValues) => {
    const result = await createTeamAction(classId, values);
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-md">
        ...
        <p className="mt-4 text-center text-sm">
          <Link href={`/instructor/classes/${classId}`} className="text-blue-500 hover:underline">
